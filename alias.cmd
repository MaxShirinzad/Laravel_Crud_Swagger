...
DOSKEY migrate=php artisan migrate:fresh --seed
DOSKEY key=php artisan key:generate
DOSKEY refresh=php artisan migrate:refresh --seed
DOSKEY fresh= cls $T php artisan migrate:fresh --seed

DOSKEY clear= php artisan cache:clear $T php artisan view:clear $T php artisan route:clear
:: ---------------------------------------------------------------
...
DOSKEY gitdev = git checkout develop
DOSKEY dev = git checkout develop
DOSKEY gitmaster = git checkout master
DOSKEY master = git checkout master
DOSKEY gitmain = git checkout main
...
:: Swagger
DOSKEY swagger= cls $T php artisan l5-swagger:generate
DOSKEY swagger2= cls $T php artisan l5-swagger:generate $T echo l5-swagger:generate is completed! $T php artisan serve
